...
public class SftpClient {
    ...
    public SftpClient init() {
        try {
            ...
            String host = PropertiesUtil.getProperty("sftp.host");
            int port = PropertiesUtil.getInt("sftp.port");
            String userName = PropertiesUtil.getProperty("sftp.user.name");
            String password = PropertiesUtil.getProperty("sftp.user.password");
